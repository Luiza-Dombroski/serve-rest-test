...
import com.serverest.utils.RestAssuredUtils;
...
public abstract class RequestRestBase {
    ...
    public ValidatableResponse executeRequest() {
        ...
        ExtentReportsUtils.addRestTestInfo(url, requestService, method.toString(), headers, cookies, queryParameters, formParameters, jsonBody, file, fileVarName, fileType, response);
